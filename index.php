	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<div class="col-xs-6 col-sm-4 col-md-2">
                ...
                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#details"><img src="user_images/<?php echo $row['userPic']; ?>" class="img-rounded" width="250px" height="250px" /></button>
				<p class="page-header">
				<span>
